...
```bash
npm install -g @trackyard/mcp-server
trackyard-mcp
```
...
<Steps>
  <Step title="Install the Trackyard skill">
    ```bash
    npx skills add https://trackyard.com/openclaw-skill
    ```
  </Step>
