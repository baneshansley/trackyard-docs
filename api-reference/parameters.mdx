...
<ParamField path="filters.genres" type="array">
  ...
  **Common genres:**
  ...
  - Hip Hop: `"Boom Bap"`, `"Trap"`, `"Lo-Fi Hip Hop"`, `"Instrumental"`
  - Cinematic: `"Orchestral"`, `"Hybrid"`, `"Trailer Music"`, `"Underscore"`
  - Corporate: `"Uplifting"`, `"Minimal"`, `"Professional"`
  - Acoustic: `"Folk"`, `"Singer-Songwriter"`, `"Indie"`, `"Americana"`
  - Classical: `"String Quartet"`, `"Piano"`, `"Chamber"`, `"Baroque"`
...
<ParamField path="filters.moods" type="array">
  ...
  **Common moods:**
  - Energy: `"Upbeat"`, `"Energetic"`, `"Motivational"`, `"Powerful"`
  - Calm: `"Chill"`, `"Relaxed"`, `"Peaceful"`, `"Ambient"`
  - Emotional: `"Warm"`, `"Nostalgic"`, `"Melancholic"`, `"Hopeful"`
  - Professional: `"Corporate"`, `"Clean"`, `"Modern"`, `"Minimal"`
  - Dramatic: `"Tense"`, `"Suspenseful"`, `"Epic"`, `"Cinematic"`
  
  **Example:** `["Upbeat", "Motivational"]`
</ParamField>
